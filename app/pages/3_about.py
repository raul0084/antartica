...
def render_about():
    ...
    st.markdown(
        ...
        <div class="hero">
            <div class="hero-tag">About Us</div>
            <div class="hero-title">Our Mission</div>
            <p class="hero-subtitle">
    ...
    team = [
        {
            ...
            "bio": "Marine Environmental Scientist - Professor at the University of Barcelona",
            "tags": ["Oceanography", "Hydrogeology", "Environmental Science"],
        },
        {
            "initials": "RAC",
            ...
            "tags": ["Data Analysis", "Data Engineering", "Modelling"],
        },
        # {
        #     "initials": "IDK",
    ...
    st.markdown(
        """
        <div> 
            <span class="contact-pill">📧 <a href="mailto:raul.avila.carbajal@gmail.com">raul.avila.carbajal@gmail.com</a></span><br>
            <span class="contact-pill">💻 <a href="https://github.com" target="_blank" rel="noopener noreferrer">https://github.com</a></span><br>
            <span class="contact-pill">🌍 <a href="https://ub.edu" target="_blank" rel="noopener noreferrer">https://ub.edu</a></span><br>
        </div>
